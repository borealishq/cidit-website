							...
							<div className="col-12 col-xl-8 mxd-grid-item no-margin">
								<div className="mxd-block__content">
									<div className="mxd-block__inner-headline">
										...
										<div className="mt-20! flex justify-end items-center gap-7">
											<span className="text-3xl! text-white">
												Nuestras redes sociales
											</span>

											<a
												href="https://www.linkedin.com/company/guaraniapy/about/"
												target="_blank"
												className="btn btn-white! text-white/70 hover:text-white"
											>
												<svg
											...
											<a
												href="https://www.instagram.com/guarania_/"
												target="_blank"
												className="btn btn-white! text-white/70 hover:text-white"
											>
												<svg
											...
											<a
												href="https://www.facebook.com/guaraniapy/"
												target="_blank"
												className="btn btn-white! text-white/70 hover:text-white"
											>
												<svg
